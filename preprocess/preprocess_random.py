...
parser.add_argument('-datapath1', default='data/datapath1/', type=str, required=False)
parser.add_argument('--datapath2', default='data/datapath2/', type=str, required=False)
parser.add_argument('--json_datapath', default='data/json_files/', type=str, required=False)
parser.add_argument('--merged_datapath', default='data/json_files/merged/merged_file.json', type=str, required=False)
